namespace x360NANDManager.MMC
{
    ...
    public interface IMMCFlasher : IFlasherOutput
    {
        ...
        void Write(string file, long filesector = 0, long startSector = 0, long sectorCount = 0, bool verify = true);
        ...
        void WriteEX(string file, long fileoffset = 0, long startSector = 0, long sectorCount = 0, bool verify = true);
